...
extension UIViewController {
    ...
    public func addRightBarButtonWithImage(_ buttonImage: UIImage) {
        ...
        // badge label
        let label = UILabel(frame: CGRect(x: 13, y: -7.5, width: 15, height: 15))
        ...
        // button
        let rightButton = UIButton(frame: CGRect(x: 0, y: 4, width: 10 , height: 10))
    ...
    @objc public func showCartView() {
        let Controller = kMainStoryboard.instantiateViewController(withIdentifier: kNotificationVC)
...
//        imageview.adjustsImageSizeForAccessibilityContentSizeCategory = .init(true);
